...
import 'package:tictactoe/config/paths.dart';
import 'package:tictactoe/repositories/auth/base_auth_repository.dart';
...
class AuthRepository extends BaseAuthRepository {
  ...
  @override
  Future<auth.UserCredential> signInByGoogle() async {
  ...
  Future<auth.UserCredential> storeUser({required credential}) async {
    ...
    if (!doc.exists) {
      _firebaseFirestore
        ...
        "name": SessionHelper.displayName,
